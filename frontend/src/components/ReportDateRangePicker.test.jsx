...
describe("ReportDateRangePicker canonical Reports variant", () => {
  it("reuses the approved Z-report interaction and commits only through OK", () => {
    ...
    // Таймаут поднят с дефолтных 5 c: тест рендерит календарь со списками часов
    // и минут (24 + 60 опций) и на медленной машине укладывается в ~5 c ровно,
    // из-за чего падал по таймауту. Проверки не менялись.
  }, 20000);
