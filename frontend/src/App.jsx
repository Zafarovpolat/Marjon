...
const router = createBrowserRouter([
  ...
  { path: "/kitchen", element: <ProtectedRoute><KitchenPage /></ProtectedRoute> },
  {
    ...
    children: [
      ...
      { path: "reports/waiters", element: <SectionPage sectionKey="waiters" eyebrow="Отчеты" title="Отчёт по официантам" description="Продажи, скорость и качество работы официантов." items={[{ title: "Продажи", text: "Выручка и количество заказов по официантам.", icon: "bi-person-lines-fill", tableKey: "sales" }, { title: "Средний чек", text: "Сравнение эффективности персонала.", icon: "bi-bar-chart", tableKey: "avgCheck" }, { title: "Сервис", text: "Скорость обслуживания и закрытия заказов.", icon: "bi-stopwatch", tableKey: "service" }]} /> },
