      ...
      body: Center(child: SingleChildScrollView(
        ...
        child: ConstrainedBox(constraints: const BoxConstraints(maxWidth: 380), child: Column(
          ...
          children: [
            ...
            TextField(key: const ValueKey('login_server_field'), controller: _server, decoration: const InputDecoration(labelText: 'Адрес сервера')),
            const SizedBox(height: 12),
            TextField(key: const ValueKey('login_email_field'), controller: _login, decoration: const InputDecoration(labelText: 'Email или телефон', hintText: 'admin@marjon.uz')),
            const SizedBox(height: 12),
            TextField(key: const ValueKey('login_pass_field'), controller: _pass, obscureText: true, decoration: const InputDecoration(labelText: 'Пароль'), onSubmitted: (_) => _submit()),
