...
def upgrade() -> None:
    ...
    op.create_table(
        ...
        sa.Column("currency", sa.String(3), server_default="UZS", nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("tax_rate", sa.Numeric(5, 2), server_default="12.0", nullable=False),
    ...
    op.create_table(
        "modifiers",
        sa.Column("id", Uuid(as_uuid=True), primary_key=True),
        sa.Column("group_id", Uuid(as_uuid=True), sa.ForeignKey("modifier_groups.id", ondelete="CASCADE"), nullable=False),
        sa.Column("company_id", Uuid(as_uuid=True), sa.ForeignKey("companies.id"), nullable=False, index=True),
        sa.Column("name", sa.String(255), nullable=False),
        sa.Column("price_delta", sa.Numeric(15, 2), server_default="0", nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("is_available", sa.Boolean, server_default=sa.text("true"), nullable=False),
        sa.Column("stop_list", sa.Boolean, server_default=sa.text("false"), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column("unit", sa.String(20), server_default="кг", nullable=False),
        sa.Column("min_quantity", sa.Numeric(15, 4), server_default="0", nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("cost_price", sa.Numeric(15, 4), server_default="0", nullable=False),
        sa.Column("total_cost", sa.Numeric(15, 2), server_default="0", nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("source", sa.String(50), server_default="pos", nullable=False),
        sa.Column("total_orders", sa.Integer, server_default="0", nullable=False),
        sa.Column("total_spent", sa.Numeric(15, 2), server_default="0", nullable=False),
    ...
    op.create_table(
        "pos_terminals",
        sa.Column("id", Uuid(as_uuid=True), primary_key=True),
        sa.Column("company_id", Uuid(as_uuid=True), sa.ForeignKey("companies.id"), index=True, nullable=False),
        sa.Column("branch_id", Uuid(as_uuid=True), sa.ForeignKey("branches.id"), index=True, nullable=False),
        sa.Column("name", sa.String(255), nullable=False),
        sa.Column("is_active", sa.Boolean, server_default=sa.text("true"), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("order_type", sa.String(20), server_default="dine_in", nullable=False),
        ...
        sa.Column("service_fee", sa.Numeric(15, 2), server_default="0", nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("note", sa.Text),
        sa.Column("modifiers", sa.JSON, server_default="[]", nullable=False),
        sa.Column("course", sa.Integer, server_default="1", nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column("provider_data", sa.JSON, server_default="{}", nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("branch_id", Uuid(as_uuid=True), sa.ForeignKey("branches.id"), nullable=False, index=True),
        sa.Column("name", sa.String(255), nullable=False),
        sa.Column("category_ids", sa.JSON, server_default="[]", nullable=False),
        sa.Column("is_active", sa.Boolean, server_default=sa.text("true"), nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column("lifetime_points", sa.Numeric(15, 2), server_default="0", nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", Uuid(as_uuid=True), primary_key=True),
        sa.Column("company_id", Uuid(as_uuid=True), sa.ForeignKey("companies.id"), nullable=False, index=True),
        sa.Column("account_id", Uuid(as_uuid=True), sa.ForeignKey("loyalty_accounts.id"), nullable=False, index=True),
    ...
    op.create_table(
        ...
        sa.Column("branch_id", Uuid(as_uuid=True), sa.ForeignKey("branches.id"), nullable=False, index=True),
        sa.Column("name", sa.String(255), nullable=False),
        sa.Column("polygon", sa.JSON, server_default="[]", nullable=False),
        sa.Column("delivery_fee", sa.Numeric(15, 2), server_default="0", nullable=False),
        sa.Column("min_order", sa.Numeric(15, 2), server_default="0", nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("name", sa.String(255), nullable=False),
        sa.Column("phone", sa.String(20), nullable=False),
        sa.Column("vehicle_type", sa.String(20), server_default="bike", nullable=False),
        sa.Column("is_active", sa.Boolean, server_default=sa.text("true"), nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("salary_type", sa.String(20), server_default="fixed", nullable=False),
        sa.Column("salary_amount", sa.Numeric(15, 2), server_default="0", nullable=False),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column("company_id", Uuid(as_uuid=True), sa.ForeignKey("companies.id"), nullable=False, index=True),
        sa.Column("employee_id", Uuid(as_uuid=True), sa.ForeignKey("employees.id"), nullable=False, index=True),
        sa.Column("shift_id", Uuid(as_uuid=True), sa.ForeignKey("work_shifts.id"), nullable=False, index=True),
        sa.Column("action", sa.String(20), nullable=False),
        sa.Column("timestamp", sa.DateTime(timezone=True), nullable=False),
        sa.Column("method", sa.String(20), server_default="manual", nullable=False),
        sa.Column("note", sa.Text),
        sa.Column("created_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
        sa.Column("updated_at", sa.DateTime(timezone=True), server_default=sa.func.now(), nullable=False),
    )
    ...
    op.create_table(
        ...
        sa.Column("fiscal_code", sa.String(255)),
        sa.Column("receipt_url", sa.Text),
        sa.Column("provider", sa.String(50), server_default="ofd_uz", nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("connection_type", sa.String(20), server_default="network", nullable=False),
        sa.Column("ip_address", sa.String(45)),
        sa.Column("port", sa.Integer, server_default="9100", nullable=False),
    ...
    op.create_table(
        ...
        sa.Column("id", Uuid(as_uuid=True), primary_key=True),
        sa.Column("company_id", Uuid(as_uuid=True), sa.ForeignKey("companies.id"), nullable=False, index=True),
        sa.Column("printer_id", Uuid(as_uuid=True), sa.ForeignKey("printers.id", ondelete="CASCADE"), nullable=False, index=True),
